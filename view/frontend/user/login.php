            ...
            <div class="col-md-6 login-form">
                ...
                <form action="" class="signup-form" method="post">
                    ...
                    <div class="d-flex justify-content-center">
                        <button class="form-submit btn btn-primary" name="btn_login">Login</button>
                    </div>
                    <div class="d-flex justify-content-center mt-3">
                        <p style="color: white;" class="signup-already forget-password"><a href="?controller=user&action=quen_mk" class="signup-already-link">Quên Mật Khẩu</a></p>
                    </div>
